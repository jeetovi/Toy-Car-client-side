...
const Banner = () => {
  ...
  <img src={avg2} className="w-full rounded-xl"  />    <div className="absolute flex items-center justify-between   transform -translate-y-1/2 left-0  
              h-full  <button className='btn btn-primary'>Car po</button>
                button-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)] right-0 top-1/2">
  ...
  <img src={avg3} className="w-full rounded-xl" />   <div className="absolute flex items-center justify-between   transform -translate-y-1/2 left-0  
              h-full  <button className='btn btn-primary'>Car po</button>
                button-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)] right-0 top-1/2">
      <a href="#slide2" className="btn btn-circle">❮</a> 
      <div className='text-white space-y-7   w-1/2'>
